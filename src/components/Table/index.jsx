...
function Table({ items, titleArea, titleAreaContent, eT, onChangeData, itemsTable }) {
            ...
            <TableArea>
                ...
                <Tbody>
                    {list.map((item, index) => (
                        ...
                        {items?.map((title, key) => (
                            !eT ?
                                <Td key={key} suppressContentEditableWarning={true} onInput={(e) => handleInput(e, title.name)} contentEditable = {key === 2 ?'false' : 'true'} />
                            : 
                                <>

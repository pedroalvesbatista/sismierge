...
const PerdasTdEscCompras = ({ nextEsco1Button, handleChangeEsco2 }) => {
      ...
      <Box sx={style}>
        <div className="d-flex justify-content-between mb-5 pt-3">
          <div>
            ...
            <h2 className="mt-3 pb-2">{btn_IERA? "Energia Eletrica": "Perdas T & D "} (Escolha de Compra)</h2>
            {btn_IERA && (
...
export default PerdasTdEscCompras;

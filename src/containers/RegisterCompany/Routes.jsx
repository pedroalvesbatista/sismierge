...
import { Inventariacao } from './Inventariacao'
...
function Routes({ page, data, setPage }) {
    const routes= ["inicio", "organisation", "organisationStep2", "unidade", "welcome", "inventariacao"]
  return (
    <>
      ...
      {page === routes[5] && <Inventariacao setPage={setPage} dataCompany={data} />}
    </>
  )
}
